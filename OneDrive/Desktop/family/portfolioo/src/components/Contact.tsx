...
export default function Contact({ onClose }: { onClose?: () => void }) {
    ...
    return (
        <motion.div
            ...
            initial={{ zIndex: 10 }}
            className="w-[500px] h-[440px] flex flex-col relative overflow-hidden cursor-grab active:cursor-grabbing backdrop-blur-3xl"
            style={{
        ...
        >
            ...
            <div className=" bg-[#1a1a1a]/40 flex-1 overflow-y-auto p-8 font-sans scrollbar-hide">
